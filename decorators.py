...
def logging(log_file="game.log"):
    def decorator(func: Callable) -> Callable[..., NewType.ret_dict]:
...
def handle_result(func: Callable) -> Callable[..., NewType.ret_dict]:
    @functools.wraps(func)
    def wrapper(*args, **kwargs) -> NewType.ret_dict:
        try:
            result = func(*args, **kwargs)
